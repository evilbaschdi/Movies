...
public class AppBasic : IAppBasic
{
    ...
    public void Reset()
    {
        ...
        try
        {
            ...
            _mainWindow.DbPath.SetCurrentValue(System.Windows.Controls.TextBox.TextProperty, fileDialog.FileName);
    ...
    public void SetComboBoxItems()
    {
        ...
        {
            case "movie":
                _mainWindow.Format.SetCurrentValue(System.Windows.Controls.ItemsControl.ItemsSourceProperty, MovieFormats);
                break;
            case "music":
                _mainWindow.Format.SetCurrentValue(System.Windows.Controls.ItemsControl.ItemsSourceProperty, MusicFormats);
                break;
        }
    }
